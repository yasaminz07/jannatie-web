          ...
          {fpStep === "idle" && (
            <>
              <div className="text-center mb-7">
                ...
                <h1 className="text-2xl font-bold text-slate-900 mb-1">Parental Dashboard</h1>
                <p className="text-sm text-slate-400">Enter your parental password to continue</p>
              </div>

              <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 p-7">
                <form onSubmit={handleUnlock} className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1.5">Parental password</label>
                  ...
                  <button type="submit" disabled={unlocking || !enteredPw} className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-3.5 rounded-xl transition-colors text-sm disabled:opacity-60 flex items-center justify-center gap-2">
                    <Unlock size={15} />
                ...
                <button
                  ...
                  className="w-full text-center text-sm text-slate-400 hover:text-amber-600 transition-colors mt-5"
                >
          ...
          {fpStep === "send" && (
            <>
              <div className="text-center mb-7">
                ...
                <h1 className="text-2xl font-bold text-slate-900 mb-1">Reset parental password</h1>
                <p className="text-sm text-slate-400">
                  We&apos;ll send a 6-digit code to the parent email on this account.
                </p>
              </div>

              <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 p-7 space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-3.5 rounded-xl transition-colors text-sm disabled:opacity-60 flex items-center justify-center gap-2"
                >
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 p-7">
                <form onSubmit={verifyResetCode} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-3.5 rounded-xl transition-colors text-sm disabled:opacity-60"
                  >
                    Verify code
                  </button>
                </form>
                ...
                <div className="flex items-center justify-between mt-5">
                  ...
                  <button
                    onClick={sendResetCode}
                    disabled={fpLoading}
                    className="text-sm text-amber-600 hover:text-amber-800 font-semibold transition-colors disabled:opacity-60"
                  >
          ...
          {fpStep === "reset" && (
            <>
              <div className="text-center mb-7">
                ...
                <p className="text-sm text-slate-400">Choose a strong parental password</p>
              </div>
                ...
                <form onSubmit={handleResetPassword} className="space-y-3">
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <button type="button" onClick={() => setFpShowPw(v => !v)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400">
                  ...
                  {fpConfirmPw.length > 0 && (
                    <div className="flex items-center gap-1">
                      ...
                      <span className={`text-xs ${fpNewPw === fpConfirmPw ? "text-emerald-600" : "text-red-400"}`}>
                  ...
                  <button
                    type="submit"
                    disabled={fpSavingPw}
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 rounded-xl transition-colors text-sm disabled:opacity-60"
                  >
